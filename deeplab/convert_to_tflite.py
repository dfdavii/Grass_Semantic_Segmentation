...
flags.DEFINE_string('quantized_graph_def_path', '/home/dfdavii/Downloads/models/research/deeplab/datasets/deeplabv3_mnv2_pascal_train_aug/frozen_inference_graph.pb',
                    'Path to quantized graphdef.')
flags.DEFINE_string('output_tflite_path', '/home/dfdavii/Downloads/models/research/deeplab/datasets/Custom_Dataset/grass2.tflite', 'Output TFlite model path.')
flags.DEFINE_string(
...
flags.DEFINE_string(
    'test_image_path', '/home/dfdavii/Downloads/models/research/deeplab/datasets/Custom_Dataset/JPEGImages/wo6.jpg',
