...
import tensorflow.compat.v1 as tf_pl
tf_pl.disable_v2_behavior()

FLAGS = tf.compat.v1.flags.FLAGS

tf.compat.v1.flags.DEFINE_enum('image_format', 'jpg', ['jpg', 'jpeg', 'png'],
                         'Image format.')
...
class ImageReader(object):
  ...
  def __init__(self, image_format='jpeg', channels=3):
    ...
    with tf.Graph().as_default():
      self._decode_data = tf_pl.placeholder(dtype=tf.string)
      self._image_format = image_format
      self._session = tf_pl.Session()
