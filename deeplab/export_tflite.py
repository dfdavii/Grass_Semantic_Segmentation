...
USE_DPC = False
CHECKPOINT_PATH = '/home/dfdavii/Downloads/models/research/deeplab/datasets/Custom_Dataset/checkpoint'

OUT_PATH_TFLITE = '/home/dfdavii/Downloads/models/research/deeplab/datasets/Custom_Dataset/grass1.tflite'
OUT_PATH_FROZEN_GRAPH = '/home/dfdavii/Downloads/models/research/deeplab/datasets/deeplabv3_mnv2_pascal_train_aug/frozen_inference_graph.pb'
...
if __name__ == '__main__':
    ...
    with g.as_default():
        with tf.Session(graph=g) as sess:
            ...
            predictions = tf.cast(
                tf.expand_dims(outputs_to_scales_to_logits[common.OUTPUT_TYPE],3), tf.int32)
