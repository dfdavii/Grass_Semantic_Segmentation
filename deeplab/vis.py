...
flags.DEFINE_string('vis_logdir', '/home/dfdavii/Downloads/models/research/deeplab/datasets/Custom_Dataset/Vis', 'Where to write the event logs.')
...
flags.DEFINE_list('vis_crop_size', '256,256',
