...
flags.DEFINE_string('checkpoint_path', '/home/dfdavii/Downloads/models/research/deeplab/datasets/Custom_Dataset/checkpoint/model.ckpt-2000',
                               'Checkpoint path')

flags.DEFINE_string('export_path', '/home/dfdavii/Downloads/models/research/deeplab/datasets/deeplabv3_mnv2_pascal_train_aug/frozen_inference_graph.pb',
                    'Path to output Tensorflow frozen graph.')

flags.DEFINE_integer('num_classes', 2, 'Number of classes.')

flags.DEFINE_multi_integer('crop_size', [256, 256],
