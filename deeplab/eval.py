...
flags.DEFINE_string('eval_logdir', '/home/dfdavii/Downloads/models/research/deeplab/datasets/Custom_Dataset/Evaluation', 'Where to write the event logs.')

flags.DEFINE_string('checkpoint_dir', '/home/dfdavii/Downloads/models/research/deeplab/datasets/Custom_Dataset/checkpoint', 'Directory of model checkpoints.')
...
flags.DEFINE_list('eval_crop_size', '256,256',
